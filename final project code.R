...
barplot(bikes,beside=T,col=c("green"
                             ,"blue"), main = "äùëøåú àåôðééí ìôé ùòä")
legend("topleft",c("éåí çåì", "ñåôù"),
       fill = c("green","blue"))
